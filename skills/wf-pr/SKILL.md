...
4. Use native `question` with concise choices and allow a custom answer before creation.
5. Call `workflow_pr_create` only after approval with `confirmed: true` and the reviewed fields.

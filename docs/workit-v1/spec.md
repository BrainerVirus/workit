...
| OpenCode               | `@opencode-ai/plugin` `1.18.29`; host `1.18.29`                                                                                                                                | Pin the build contract and validate the native plugin against the same host release; do not ship the SDK as a runtime dependency.                                     |

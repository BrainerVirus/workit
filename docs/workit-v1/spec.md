...
| OpenCode               | `@opencode-ai/plugin` `1.18.30`; host `1.18.30`                                                                                                                                | Pin the build contract and validate the native plugin against the same host release; do not ship the SDK as a runtime dependency.                                     |
| Pi                     | `@earendil-works/pi-coding-agent` `0.85.1`                                                                                                                                     | Pin the development fixture and declare the tested `^0.85.1` peer line; do not bundle Pi itself.                                                                      |
| Codex                  | Codex CLI `0.153.4` qualification target                                                                                                                                       | Codex is a host, not a Workit runtime dependency. Test CLI and desktop separately and record the desktop build used.                                                  |
